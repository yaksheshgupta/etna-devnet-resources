...
require (
	...
	github.com/ava-labs/avalanche-network-runner v1.8.4-0.20241113212913-591353070499 // indirect
	github.com/ava-labs/awm-relayer v1.4.1-0.20241101130521-c20945eebe03 // indirect
